# Generated by Powerlevel10k configuration wizard on 2026-07-17 at 14:10 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_PRIVATE_VISUAL_IDENTIFIER_EXPANSION="%244F%f"
  typeset -g POWERLEVEL9K_DIR_SCRATCH_VISUAL_IDENTIFIER_EXPANSION="%244F%f"
  typeset -g POWERLEVEL9K_DIR_WORK_VISUAL_IDENTIFIER_EXPANSION="%244F%f"
  ...
  # https://github.com/romkatv/powerlevel10k?tab=readme-ov-file#why-does-git-status-sometimes-appear-grey-and-then-gets-colored-after-a-short-period-of-time
